...
@Component({
  selector: 'app-paginador-contribuyentes',
  templateUrl: './paginador-contribuyentes.component.html',
  styleUrls: ['./paginador-contribuyentes.component.css']
})
export class PaginadorContribuyentesComponent implements OnInit, OnChanges {
