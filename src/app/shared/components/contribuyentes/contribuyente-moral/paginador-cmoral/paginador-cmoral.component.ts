...
@Component({
  selector: 'app-paginador-cmoral',
  templateUrl: './paginador-cmoral.component.html',
  styleUrls: ['./paginador-cmoral.component.css']
})
export class PaginadorCmoralComponent implements OnInit {
