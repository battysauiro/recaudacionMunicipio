...
@Component({
  selector: 'app-paginador-impuesto',
  templateUrl: './paginador-impuesto.component.html',
  styleUrls: ['./paginador-impuesto.component.css']
})
export class PaginadorImpuestoComponent implements OnInit {
